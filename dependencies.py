...
doc_requires = ['sphinx>=1.7', 'jupyter_sphinx', 'matplotlib', _PYSIDE, 'ipyparallel>=6.2.5', 'python-slugify',
                'ipywidgets', 'sphinx-qt-documentation', 'bash_kernel', 'sphinx-material', 'sphinx-autoapi'] + install_requires
ci_requires = [_PYTEST, 'pytest-cov', 'pytest-xdist', 'check-manifest', 'nbconvert', 'pytest-parallel', 'pytest-qt',
